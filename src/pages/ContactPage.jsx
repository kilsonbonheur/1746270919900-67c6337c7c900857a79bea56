...
function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Address",
      details: [
        "P114 Sheikha Maryam Building,",
        "Baniyas Rd - Al Rigga - Deira - Dubai",
      ],
    },
    {
  ...
  return (
    <div id="contact_page">
            ...
            <div className="lg:col-span-1">
                    ...
                    <div className="ml-4">
                      ...
                      {item.link ? (
                        <a
                          ...
                          className="text-lg font-extralight text-green-600 hover:underline"
                        >
                          {item.details[0]}
                        </a>
                      ) : (
                        item.details.map((detail, detailIndex) => (
                          <p
                            key={detailIndex}
                            className="text-lg font-extralight text-gray-600"
                          >
                            {detail}
                          </p>
                        ))
              ...
              <div className="mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn bg-green-500 hover:bg-green-600 text-white w-full text-center"
                >
      ...
      <div className="h-96 w-full">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.8963!2d55.3075!3d25.2697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5ccfb1b9c96d%3A0x2d8e4d3b5e0b0c0a!2sAl%20Rigga%2C%20Deira%2C%20Dubai!5e0!3m2!1sen!2sae!4v1700000000000!5m2!1sen!2sae"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
